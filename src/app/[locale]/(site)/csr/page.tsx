      ...
      <SectionContainer className="bg-white dark:bg-slate-900">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-8 rounded-[40px] bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-center transition-colors">
              <p className="text-4xl font-black text-primary mb-2">10k+</p>
              <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Outgrowers supported</p>
            </div>
            <div className="p-8 rounded-[40px] bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-center transition-colors">
              <p className="text-4xl font-black text-primary mb-2">1M+</p>
              <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Trees planted yearly</p>
            </div>
            <div className="p-8 rounded-[40px] bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-center transition-colors">
              <p className="text-4xl font-black text-primary mb-2">25+</p>
              <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Local schools engaged</p>
            </div>
            <div className="p-8 rounded-[40px] bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-center transition-colors">
              <p className="text-4xl font-black text-primary mb-2">31MW</p>
              <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Renewable energy</p>
            </div>
          </div>
        </div>
      </SectionContainer>
        ...
        <SectionContainer>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {pillars.map((pillar, i) => (
              <div key={i} className="group p-8 bg-white dark:bg-slate-800/50 rounded-[40px] border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:shadow-xl hover:-translate-y-2">
