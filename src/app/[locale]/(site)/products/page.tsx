        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.length > 0 ? products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="group relative flex flex-col bg-white dark:bg-slate-800 rounded-[40px] border border-slate-100 dark:border-slate-700 p-8 shadow-card transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 overflow-hidden"
              >
                ...
                <div className="relative mb-8 aspect-square rounded-3xl overflow-hidden bg-slate-100 dark:bg-slate-700">
