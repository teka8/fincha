      ...
      <div className="flex flex-col">
         ...
         <SectionContainer className="bg-white dark:bg-slate-900">
            <div className="flex flex-col gap-12">
               <div className="flex items-center gap-4 border-b border-slate-100 dark:border-slate-800 pb-8 flex-wrap">
                  <button className="px-6 py-2.5 rounded-full bg-slate-900 dark:bg-primary text-white font-bold text-sm">Active Tenders</button>
                  <button className="px-6 py-2.5 rounded-full bg-slate-100 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 font-bold text-sm hover:bg-slate-200 dark:hover:bg-slate-700">Recent Awards</button>
                  <button className="px-6 py-2.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 font-bold text-sm hover:bg-slate-200 dark:hover:bg-slate-700">Archive</button>
               </div>
               ...
               <div className="grid gap-6">
                  {tenders.length > 0 ? tenders.map((tender) => (
                     <div
                        key={tender.id}
                        className="group flex flex-col lg:flex-row lg:items-center gap-8 p-10 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-[40px] shadow-sm transition-all hover:shadow-xl hover:border-primary/20"
                     >
                        <div className="flex-1 space-y-4">
                           ...
                           <h3 className="text-2xl font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors">{tender.title}</h3>
                        ...
                        <div className="flex flex-wrap lg:flex-nowrap items-center gap-6 lg:border-l lg:border-slate-100 lg:pl-10">
                           ...
                           <div className="flex gap-2">
                              ...
                              <button className="size-12 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:text-primary hover:border-primary transition-all">
                     ...
                     // Fallback tenders
                     [1, 2, 3].map((i) => (
                        <div key={i} className="p-10 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-[40px] opacity-60">
               ...
               <div className="p-8 rounded-[40px] bg-primary-50 dark:bg-primary-950/30 border border-primary/10 flex flex-col md:flex-row items-center gap-8">
                  <div className="size-16 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-primary shrink-0 shadow-sm">
                     <LucideInfo size={32} />
                  </div>
                  <div className="flex-1 text-center md:text-left">
                     <h4 className="text-lg font-bold text-primary-950 dark:text-primary-100 mb-1">Procurement Guidelines</h4>
                     <p className="text-sm text-primary-900/60 dark:text-primary-200/60 leading-relaxed">
                        Be sure to review our updated vendor registration requirements for 2024 before submitting your bid.
                     </p>
                  </div>
                  <Link href="/downloads" className="px-8 py-3.5 rounded-2xl bg-white dark:bg-slate-800 text-primary font-bold text-sm border border-primary/20 hover:bg-primary hover:text-white transition-all">
                     Download forms
                  </Link>
               </div>
            </div>
         ...
         <section className="bg-slate-50 dark:bg-slate-900/50 py-20">
            <div className="max-w-layout mx-auto px-8 grid md:grid-cols-2 gap-12">
               <div className="p-10 rounded-[40px] bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col items-center text-center">
                  <LucideGavel size={48} className="text-primary mb-6" />
                  <h3 className="text-xl font-bold mb-4 dark:text-white">Supplier Registration</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">Join our certified database of suppliers and stay notified about upcoming procurement cycles.</p>
               ...
               <div className="p-10 rounded-[40px] bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-bold mb-4 dark:text-white">Tender FAQ</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">Have questions about our bidding process? Read our detailed guide for prospective suppliers.</p>
