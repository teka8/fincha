    ...
    <SectionContainer className="relative overflow-hidden bg-transparent">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <motion.div
          ...
          className="hover-lift group relative overflow-hidden rounded-3xl border border-primary/10 bg-white p-8 shadow-card"
        >
          {/* Gradient accent */}
          ...
          <div className="relative">
            ...
            <p className="mt-6 text-xl font-semibold text-slate-900">{focusTitle}</p>
            <p className="mt-3 text-base leading-relaxed text-muted">{focusDescription}</p>
        ...
        <motion.div
          ...
          className="hover-lift group relative overflow-hidden rounded-3xl border border-accent/10 bg-white p-8 shadow-card"
        >
          {/* Gradient accent */}
          ...
          <div className="relative">
            ...
            <p className="mt-6 text-xl font-semibold text-slate-900">{impactTitle}</p>
            <p className="mt-3 text-base leading-relaxed text-muted">{impactDescription}</p>
            {/* Progress bar */}
